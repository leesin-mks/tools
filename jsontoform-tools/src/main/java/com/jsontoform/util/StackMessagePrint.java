...
public class StackMessagePrint {
	...
	public static String printStackTrace() {
		...
		for (int i = 0; i < elements.length; i++) {
			...
			buf.append("    ").append(elements[i].getClassName()).append(".").append(elements[i].getMethodName()).append("(").append(elements[i].getFileName()).append(":")
					.append(elements[i].getLineNumber()).append(")").append("\n");
		}
	 ...
	 * @param stacks
	 */
	public static void printError(Logger logger, String exception, StackTraceElement[] stacks) {
